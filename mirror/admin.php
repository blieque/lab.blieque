...
# the settings. Useful for storing settings that don't/can't be changed from the control panel\r\n";
		...
		<form action="{$self}?install" method="post">
			...
			<p><input class="btn" value="Submit &raquo;" name="submit" type="submit"{$tpl->disabled}></p>
		</form>
	...
	case 'login':
		...
		echo <<<OUT
			...
			<form action="{$self}?login" method="post">
				...
				<p><input class="btn" value="Submit &raquo;" name="loginsubmit" type="submit"></p>
			</form>
OUT;
...
OUT;
		...
		if ( empty($CONFIG['version']) || version_compare(forCompare(ADMIN_VERSION), forCompare($CONFIG['version']), '>') ) {
			echo '<p class="error-color">Your settings file needs updating. <input class="btn" type="submit" name="submit" value="Update &raquo;"></p>';
		}
...
OUT;
		...
		echo <<<OUT
		<div class="hr"></div>
		<p class="center"><input class="btn" type="submit" name="submit" value="Save Changes"{$tpl->disabled}></p>
		</form>
		...
		echo <<<OUT
				...
				<table class="form_table" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td><input type="text" name="destination" class="inputgri wide-input" value="{$destination}"> <input type="submit" class="btn" value="Update &raquo;"></td>
					</tr>
				</table>
				</form>
				<div class="hr"></div>
